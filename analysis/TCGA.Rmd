...
**Analysing RNAseq Gene Expression Data from a Colerectal Adenocarcinoma Cohort:**
...
quiet <- function(expr) {
  suppressWarnings(suppressMessages({
    res <- NULL
    invisible(capture.output(res <- force(expr)))
    res
  }))
}
path <- "../Data/Genesets/msigdb_v2023.2.Hs_GMTs/c2.cp.kegg_legacy.v2023.2.Hs.symbols.gmt"

geneset <- quiet(GSA.read.gmt(path))
