...
Use the following commands to install clinical package
Once installed, load the clinical package into your R session.
```{r, warning=FALSE, message=FALSE}
install.packages("clinical")
library(clinical)
...
ma=initialization(hosp) 

ma=add_analysis(ma,"Gender",gender)
ma=add_analysis(ma,"Gleason score",GS) 
ma=add_analysis(ma,"BMI",BMI) 
ma=add_analysis(ma,"Age",age)
ma



write.csv(ma@x,"output/Table.csv")
```
